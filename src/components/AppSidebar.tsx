...
import { ChevronRight, ChevronDown, Folder, FileText, Layout, Plus, Trash2, Download, LogOut, Shield } from 'lucide-react';
...
export function AppSidebar() {
  ...
  return (
    <div className="w-64 h-full bg-[#0a0a0a] text-white border-r border-[#333] flex flex-col">
      <div className="p-4 border-b border-[#333] flex justify-between items-center">
        <span className="tracking-widest uppercase text-xs font-bold text-[#66fcf1]">Vault OS</span>
        {profile?.role !== 'viewer' && (
          <button onClick={handleCreateSpace} title="New Space" className="hover:text-[#66fcf1]"><Plus size={16} /></button>
        )}
      </div>
      ...
      <div className="p-4 border-t border-[#333] flex flex-col gap-3 text-xs">
